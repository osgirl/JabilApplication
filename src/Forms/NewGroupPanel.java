 ...
 * @author Sowa
 */
public class NewGroupPanel extends javax.swing.JPanel {

    public static NewGroupPanel newGroupPanel;
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        sqlConnector.addItemToTable("Group", jTextField1.getText(), jTextField2.getText(), jTextArea1.getText(), jCheckBox1.isSelected());
        newGroupPanel.setVisible(false);
        GroupPanel.groupPanel.setVisible(true);
        GroupPanel.groupPanel.refreshItemList();
       }else JOptionPane.showMessageDialog(newGroupPanel, "Group name is empty or already exists! Chose new name or edit existing group.");
