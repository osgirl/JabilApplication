...
public class GroupPanel extends javax.swing.JPanel {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(newGroupButton, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(editGroupButton, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void refreshItemList() {
        ...
        String query = "SELECT DataName FROM "+PropertiesClass.props.DB_NAME+".Group;";
    ...
    private void loadItemDetails(int selectedIndex){
     String query = "SELECT * FROM "+PropertiesClass.props.DB_NAME+".Group WHERE DataName = '"+groupNames[selectedIndex]+"';";
        String[] vendorDetails = sqlConnector.getQueryFirstRow(query,7);
    ...
    private void newGroupButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newGroupButtonActionPerformed
        NewGroupPanel ngPanel = new NewGroupPanel();
        Classes.CDSApplet.cdsApplet.add(ngPanel);
        groupPanel.setVisible(false);
    ...
    private void editGroupButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editGroupButtonActionPerformed
        EditGroupPanel egPanel = new EditGroupPanel(jList1.getSelectedValue().toString());
        Classes.CDSApplet.cdsApplet.add(egPanel);
        groupPanel.setVisible(false);
